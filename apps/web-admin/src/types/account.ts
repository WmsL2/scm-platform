...
export interface AccountRole { id: string; role_code: string; role_name: string; is_builtin: boolean; permission_ids: string[] }
export interface RoleCreateRequest { role_code: string; role_name: string }
