export interface AccountUser { id: string; username: string; user_status: string; role_ids: string[]; reviewed_by: string | null; reviewed_at: string | null; review_note: string | null }
