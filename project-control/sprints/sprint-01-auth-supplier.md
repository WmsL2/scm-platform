...
- Auth Session Refresh: IMPLEMENTED; Revision `20260911_0021` adds server-side sessions, rotating HttpOnly Refresh Token, three-day sliding inactivity expiry, thirty-day absolute expiry and immediate revocation on logout/password change/user unavailability.
- PENDING: Role disable policy remains future Auth scope. Enterprise, tax, address, banking and qualification fields not confirmed by supplier source material remain locally GATED and must not be invented.
