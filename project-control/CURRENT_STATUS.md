...
- 主任务：Product Import 已实现固定 32 列 Staging、类目/价格直接保存、WPS/Excel 内嵌图片相对本地保存、来源供应商精确匹配、预览、人工解析、供应商 + SKU 防重和原子 Confirm（Revision `20260911_0018`，ADR-0010/0011）。
