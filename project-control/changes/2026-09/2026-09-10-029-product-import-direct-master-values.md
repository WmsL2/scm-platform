...
- Alembic revision `20260910_0011` makes `scm_product.category_id` nullable and adds `category_level1_name`, `category_level2_name` and `category_level3_name`.
...
- `alembic upgrade head`, `alembic current`, `alembic heads` — `20260910_0011` is the local single Head.
